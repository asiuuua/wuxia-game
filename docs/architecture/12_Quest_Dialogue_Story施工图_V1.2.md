...
本图门禁编号一律使用 **LN 逻辑编号 = 宪法 §88 GATE01~20 ∪ 01 §127 GATE21~32**（04 §2 政策，待 T-1 追认）；不裸引物理槽位号。
...
- `01_总体架构施工图_V1.2.md` §50 Quest / §51 Dialogue / §52 Story / §80 Story Editor / §110 VS-002 / §127 Gate 基线
- `02_Domain_Kernel施工图_V1.2.md` Condition·Effect·Command 契约 / ErrorCode / O-1 开放问题
- `03_Contract_Schema_DataContract施工图_V1.2.md` ID 白名单 / SemVer / 本地化 key / 资产 ID / Reference 环检测
- `04_Test_Infrastructure_Architecture_Gate施工图_V1.2.md` Gate Registry / 契约测试六类
- `05_Content_Registry_Content_Pipeline施工图_V1.2.md` ShardCache·pin / Index / Pack 收编 / C-3 分片 npc_id
- `06_Actor_Player_NPC施工图_V1.2.md` _global_flags→World-Story / _quest_phase→CampaignState
- `07_World_Time_Schedule施工图_V1.2.md` TimeConsumer 分相消费范式
- `08_Relationship_Faction施工图_V1.2.md` ModifyRelationshipEffect 收编
- `09_Item_Inventory_Equipment施工图_V1.2.md` add_item 事务 / 来源留痕 quest:<id>
- `10_Economy_Shop_Crafting施工图_V1.2.md` Money Mutation / MoneyChangedEvent / EC-R11
- `11_Ability_Combat_CombatAI施工图_V1.2.md` combat_finished 快照消费端 / learn_ability
