# 04 Test Infrastructure / Architecture Gate 施工图 V1.2
...
| GATE15 | Domain Godot Access | arch_lint --rules api（Node/get_tree 面） | PLANNED（Phase1） | 同上 |
...
- `PROJECT_CONSTITUTION_V1.2.md`（§92 校验器 / §93 Forbidden API / §115~120 测试架构 / §127 Gate 基线 / §171 升级不丢弃）
- `01_总体架构施工图_V1.2.md`（§92/93/94/95/96/115~120/127/129）
- `02_Domain_Kernel施工图_V1.2.md`（K-R01~R18 · GameClock/RandomProvider/Repository/MutationRecord 契约）
- `03_Contract_Schema_DataContract施工图_V1.2.md`（C-R01~C-R18 · SaveHeader · ID 正则）
