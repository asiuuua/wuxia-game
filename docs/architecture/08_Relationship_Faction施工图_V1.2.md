# 08 Relationship / Faction 施工图 V1.2
...
- `PROJECT_CONSTITUTION_V1.2.md`（§37 Memory / §39 Relationship / §40~42 Romance·Marriage 边界 / L2034-2053 Owner 表 / L3079 Memory 五类）
- `01_总体架构施工图_V1.2.md`（§48 Relationship / §55 Faction / §38 Owner 基线 / §597 ModifyRelationshipEffect）
- `02_Domain_Kernel施工图_V1.2.md`（Command/Query/Event / Transaction / EntityId）
- `06_Actor_Player_NPC施工图_V1.2.md`（NPC Definition / Relationship Ref / SV-1 切片纪律）
- `05_Content_Registry_Content_Pipeline施工图_V1.2.md`（relations/sects 归 Definition / ID 校验 / 引用悬空拦截）
